<?php // table in a function  
    function getmetingen() { // ZELF DOEN VERSIE
    ...
    function getMeting($kenteken) {  // ZELF DOEN VERSIE 
    ...
    function updateMeting($kenteken, $nieuweWaarde) {  // ZELF DOEN VERSIE
    ...
    function getRoetwaarde($kenteken) {  // ZELF DOEN VERSIE
