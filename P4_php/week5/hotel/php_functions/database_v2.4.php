...
$serverInfo = ["Servername" => "localhost", "Username" => "root", "Password" => "", "Databasename" => "hotel"]; //Servername, Username, password, dbname
...
function insertIntoDatabase($tableName, $columnNames) {
    ...
    if ($test == 'true') {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            $returnMessage = "<script type='text/javascript'>alert('$message');</script>";
            $returnMessage .= "<script type='text/javascript'>('window.location.reload();')</script>";
        }
...
function insertWithPDO($tableName, $columnNames) {

    //Gets the global serverInfo for this function
    global $serverInfo;

    //Set information for the connection with PDO
    $servername = $serverInfo['Servername'];
    $dbname = $serverInfo['Databasename'];
    ...
    try {
        ...
        {
        $returnMessage = $sql . "<br>" . $e->getMessage();
        }
